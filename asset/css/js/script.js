...
const leftbtntwo = document.querySelector('.bx-chevron-left-tow')
...
rightbtntwo.addEventListener("click", function(){
  ...
  document.querySelector(".slider-product-one-content-content-items-content").style.right = index * 100+ "%"
})
